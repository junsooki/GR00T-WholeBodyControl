...
const std::array<double, 31> h2_action_scale = {
    0.25 * 360.0 / (1.0 * STIFFNESS_7520_22), // left_hip_pitch_joint
    0.25 * 360.0 / (1.0 * STIFFNESS_7520_22), // left_hip_roll_joint
    0.25 * 360.0 / (1.0 * STIFFNESS_7520_14), // left_hip_yaw_joint
    0.25 * 360.0 / (1.0 * STIFFNESS_7520_22), // left_knee_joint
    0.25 * 19.0 / (2.0 * STIFFNESS_5020), // left_ankle_roll_joint
    0.25 * 66.88 / (2.0 * STIFFNESS_5020), // left_ankle_pitch_joint
    0.25 * 360.0 / (1.0 * STIFFNESS_7520_22), // right_hip_pitch_joint
    0.25 * 360.0 / (1.0 * STIFFNESS_7520_22), // right_hip_roll_joint
    0.25 * 360.0 / (1.0 * STIFFNESS_7520_14), // right_hip_yaw_joint
    0.25 * 360.0 / (1.0 * STIFFNESS_7520_22), // right_knee_joint
    0.25 * 19.0 / (2.0 * STIFFNESS_5020), // right_ankle_roll_joint
    0.25 * 66.88 / (2.0 * STIFFNESS_5020), // right_ankle_pitch_joint
    0.25 * 120.0 / (1.0 * STIFFNESS_7520_14), // waist_yaw_joint
    0.25 * 180.0 / (2.0 * STIFFNESS_5020), // waist_roll_joint
    0.25 * 180.0 / (2.0 * STIFFNESS_5020), // waist_pitch_joint
    0.25 * 50.0 / (2.0 * STIFFNESS_5020), // head_pitch_joint
    0.25 * 50.0 / (2.0 * STIFFNESS_5020), // head_yaw_joint
    0.25 * 120.0 / (1.0 * STIFFNESS_5020), // left_shoulder_pitch_joint
    0.25 * 54.0 / (1.0 * STIFFNESS_5020), // left_shoulder_roll_joint
    0.25 * 54.0 / (1.0 * STIFFNESS_5020), // left_shoulder_yaw_joint
    0.25 * 54.0 / (1.0 * STIFFNESS_5020), // left_elbow_joint
    0.25 * 54.0 / (1.0 * STIFFNESS_5020), // left_wrist_roll_joint
    0.25 * 25.0 / (1.0 * STIFFNESS_4010), // left_wrist_pitch_joint
    0.25 * 25.0 / (1.0 * STIFFNESS_4010), // left_wrist_yaw_joint
    0.25 * 120.0 / (1.0 * STIFFNESS_5020), // right_shoulder_pitch_joint
    0.25 * 54.0 / (1.0 * STIFFNESS_5020), // right_shoulder_roll_joint
    0.25 * 54.0 / (1.0 * STIFFNESS_5020), // right_shoulder_yaw_joint
    0.25 * 54.0 / (1.0 * STIFFNESS_5020), // right_elbow_joint
    0.25 * 54.0 / (1.0 * STIFFNESS_5020), // right_wrist_roll_joint
    0.25 * 25.0 / (1.0 * STIFFNESS_4010), // right_wrist_pitch_joint
    0.25 * 25.0 / (1.0 * STIFFNESS_4010), // right_wrist_yaw_joint
};
